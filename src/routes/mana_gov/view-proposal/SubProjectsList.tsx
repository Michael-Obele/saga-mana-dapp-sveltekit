...
const SubProjectsList: React.FC<SubProjectsListProps> = ({ subProjects }) => {
    return (
        <div>
            <h3 className="mt-4 text-lg font-semibold text-amber-900">Sub-Projects:</h3>
            {subProjects.length === 0 ? (
                <p className="text-amber-700">No sub-projects found for this proposal.</p>
            ) : (
                <ul className="ml-6 list-inside list-disc text-amber-800">
